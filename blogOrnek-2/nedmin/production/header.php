        ...
        <div class="col-md-3 left_col">
            <div class="left_col scroll-view">
                <div class="navbar nav_title" style="border: 0;">
                    <a href="index.php" class="site_title"><i class="fa fa-paw"></i> <span>Şeyda'nın Bloğu</span></a>
                </div>
                ...
                <div class="profile clearfix">
                    <div class="profile_pic">
                        <img src="/nedmin/production/img/profil.jpg" alt="..." class="img-circle profile_img" >
                    </div>
