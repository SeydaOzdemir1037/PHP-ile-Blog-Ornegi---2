    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 mt-2 mb-4">
                ...
                <ul class="social-pet mt-3">
                    <li><a href="http://www.facebook.com/" title="facebook"><i class="fa fa-facebook-square"></i></a></li>
                    <li><a href="http://www.twitter.com/" title="twitter"><i class="fa fa-twitter-square"></i></a></li>
                    <li><a href="http://www.instagram.com/" title="instagram"><i class="fa fa-instagram"></i></a></li>
                </ul>
            </div>
        </div>
    </div>
